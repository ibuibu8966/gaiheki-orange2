...
const HeroSection = () => {
  ...
  return (
    <section className="relative py-16 md:py-24 lg:py-28 px-4 overflow-hidden bg-gradient-to-br from-[#1B4F72] via-[#154360] to-[#0E2F44]">
      {/* 背景装飾 */}
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-8 animate-fadeIn">
          <div className="flex items-center gap-2 bg-white/15 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20">
            ...
            <span className="text-white text-sm font-medium">創業10年以上の実績</span>
          </div>
          <div className="flex items-center gap-2 bg-white/15 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20">
            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
            </svg>
            <span className="text-white text-sm font-medium">塗装業界経験10年</span>
          </div>
          <div className="flex items-center gap-2 bg-white/15 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20">
            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="animate-fadeIn" style={{animationDelay: '0.2s'}}>
          ...
          <p className="text-lg md:text-xl text-white/80 leading-relaxed max-w-2xl mx-auto">
            業界経験10年の専門家が、お客様に最適な施工会社をご案内いたします
          </p>
        </div>
