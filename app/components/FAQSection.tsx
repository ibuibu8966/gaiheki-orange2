...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "外壁塗装パートナーズとはどのようなサービスですか？",
      answer: "外壁塗装パートナーズは、全国の優良な外壁塗装業者と施工をお考えのお客様をお繋ぎするサービスでございます。厳しい審査基準をクリアした業者のみをご紹介し、お客様に最適な業者選びをサポートいたします。"
    },
    {
      question: "ご相談やお見積りのご依頼に費用はかかりますか？",
      answer: "ご相談、お見積りは完全無料でございます。外壁塗装パートナーズへのご相談から業者のご紹介、お見積りまで一切費用はかかりません。どうぞ安心してご利用くださいませ。"
    },
    {
