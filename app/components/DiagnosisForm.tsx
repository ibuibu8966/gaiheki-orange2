        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="lg:w-2/5 text-center lg:text-left">
            ...
            <p className="text-gray-600 text-base mb-2">
              ＼ 簡単<span className="text-brand text-3xl font-bold mx-1">10</span>秒相場CHECK ／
            </p>
          ...
          <div className="lg:w-3/5">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-start">
                <label className="w-28 sm:w-36 text-base font-medium text-gray-700 shrink-0 pt-4">
                  お名前
                </label>
                <span className="text-brand text-sm mr-2 sm:mr-4 pt-4 shrink-0">必須</span>
                <div className="flex-1 min-w-0">
                  <input
                    type="text"
                    {...register("name")}
                    placeholder="山田 太郎"
                    className="w-full px-5 py-4 text-lg bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-gray-900 placeholder-gray-400"
                  />
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1 min-w-0">
                  <select
                    {...register("prefecture")}
                    className="w-full px-5 py-4 text-lg bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-gray-900"
                  >
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1 min-w-0">
                  <input
                    ...
                    className="w-full px-5 py-4 text-lg bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-gray-900 placeholder-gray-400"
                  />
              ...
              <div className="flex items-start">
                ...
                <span className="text-gray-500 text-sm mr-2 sm:mr-4 pt-4 shrink-0">任意</span>
                <div className="flex-1 min-w-0">
                  <input
                    type="email"
                    {...register("email")}
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full bg-brand hover:bg-brand-hover text-white font-bold py-5 px-8 rounded-full text-xl transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <span className="bg-white text-brand text-base font-bold px-3 py-1 rounded">無料</span>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 text-center">
                <p className="text-base text-gray-600 mb-4">お電話でのご相談も承っております</p>
                <a
                  href="tel:0120-945-990"
                  className="inline-flex items-center justify-center gap-3 bg-white border-2 border-brand text-brand hover:bg-brand hover:text-white font-bold py-4 px-8 rounded-xl text-xl transition-all duration-300"
                >
