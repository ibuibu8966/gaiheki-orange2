          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div className="grid grid-cols-7 divide-x divide-gray-200">
              <div className="px-4 py-3 text-center">
                ...
                <div className="text-lg font-bold text-blue-900">¥{(dashboardData.kpi.total_referral_fee / 10000).toFixed(0)}万</div>
              </div>

              <div className="px-4 py-3 text-center">
                <div className="text-xs text-green-600 font-medium mb-1">保証金残高</div>
                <div className="text-lg font-bold text-green-900">¥{(dashboardData.kpi.total_deposit_balance / 10000).toFixed(0)}万</div>
              </div>

              <div className="px-4 py-3 text-center">
                <div className="text-xs text-cyan-600 font-medium mb-1">診断依頼</div>
                <div className="text-lg font-bold text-cyan-900">{dashboardData.kpi.total_diagnoses}件</div>
              </div>

              <div className="px-4 py-3 text-center">
                <div className="text-xs text-pink-600 font-medium mb-1">紹介数</div>
                <div className="text-lg font-bold text-pink-900">{dashboardData.kpi.total_referrals}件</div>
              </div>

              <div className="px-4 py-3 text-center">
                <div className="text-xs text-indigo-600 font-medium mb-1">成約数</div>
                <div className="text-lg font-bold text-indigo-900">{dashboardData.kpi.decided_diagnoses}件</div>
              </div>
